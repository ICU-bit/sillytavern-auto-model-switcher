...
export function buildInputFieldHtml(id, labelText, type, placeholder, required) {
...
/** 构建复选框字段 HTML */
export function buildCheckboxFieldHtml(id, labelText, checked) {
...
/** 构建带图标的区块标题 HTML */
export function buildSectionTitleHtml(iconClass, titleText) {
    return '<div class="nsfw-section-title">' +
        '<i class="' + iconClass + '"></i>' + titleText +
        '</div>';
}
/** 状态指示器区域 */
export function buildStatusSectionHtml() {
...
/** 启用插件开关 */
export function buildEnableSectionHtml() {
...
/** 轻量化检测模型配置 */
export function buildDetectionModelSectionHtml() {
    return '<div class="nsfw-settings-section">' +
...
/** 切换目标模型配置 */
export function buildTargetModelSectionHtml() {
    return '<div class="nsfw-settings-section">' +
...
/** 选项设置 */
export function buildOptionsSectionHtml() {
    return '<div class="nsfw-settings-section">' +
...
/** 高级设置 */
export function buildAdvancedSectionHtml() {
    return '<div class="nsfw-settings-section">' +
...
/** 预设管理区域 */
export function buildPresetSectionHtml() {
...
/** 运行日志区域 */
export function buildLogsSectionHtml() {
